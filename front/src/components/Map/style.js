...
exports.countries = {
    ...
    "layers": [{
        ...
        "type": "fill",
        "source": "countries",
        "filter": ["in", "ADM0_A3", 'AFG', 'ALD', 'BEN', 'BLR', 'BWA', 'COK', 'COL', 'DNK', 'DOM', 'ERI', 'FIN', 'FRO', 'GIB', 'GNB', 'GNQ', 'GRC', 'GTM', 'JPN', 'KIR', 'LKA', 'MHL', 'MMR', 'MWI', 'NCL', 'OMN', 'RWA', 'SMR', 'SVK', 'SYR', 'TCD', 'TON', 'URY', 'WLF'],
        "source-layer": "country",
        "paint": {
            "fill-color": "#fdaf6b"
        }
...
exports.global = {
    ...
    "sources": {
        "countries": {
            "type": "raster",
            "tiles": [location.origin + location.pathname + "mapbox-gl/google-tiles/{z}/{x}/{y}.jpg"],
            "maxzoom": 15
        }
    },
    "glyphs": location.origin + location.pathname + "mapbox-gl/font/{fontstack}/{range}.pbf",
